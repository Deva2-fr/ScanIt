...
async def register(
    ...
    # Note: send_verification_email must be async-compatible or wrapped properly
    # Here assuming we call the async function. BackgroundTasks.add_task accepts async functions.
