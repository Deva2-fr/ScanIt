...
class RenderingService:
    ...
    @classmethod
    def _fetch_sync(cls, url: str, timeout: int) -> tuple[str, Optional[bytes]]:
        """Sync implementation of fetching. Returns (html_content, screenshot_bytes)"""
        try:
            with sync_playwright() as p:
                ...
                try:
                    ...
                    try:
                        ...
                        # Fallback to viewport if full_page fails
                        try:
